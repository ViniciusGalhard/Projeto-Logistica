...
namespace Projeto_Logistica
{
    public partial class PaginaBuscaContratanteNovo : Form
    {
        ...
        private void carregaAtendente()
        {
            ...
            //tbxBuscaContratanteDestino.Text = dvgBuscaContratante.SelectedRows[0].Cells[0].ToString();
            //tbxBuscaContratanteDatasaida.Text = dvgBuscaContratante.SelectedRows[0].Cells[0].ToString();
            //tbxBuscaContratanteDatachegada.Text = dvgBuscaContratante.SelectedRows[0].Cells[0].ToString();
            //cbxBuscaContratanteTipocarga.Text = dvgBuscaContratante.SelectedRows[0].Cells[0].ToString();
            //tbxBuscaContratanteCargamaxima.Text = dvgBuscaContratante.SelectedRows[0].Cells[0].ToString();
